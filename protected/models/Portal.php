...
class Portal extends CActiveRecord
{
    ...
    protected function beforeSave()
    {
        ...
        {
            if($background=CUploadedFile::getInstance($this,'background'))
            {
                $this->background=file_get_contents($background->tempName);
                $this->background_content_type = $background->type;
            }
